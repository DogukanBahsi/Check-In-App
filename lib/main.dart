            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(
                  colors: [Color(0xFFC61111), Color(0xFF990000)],
                ...
                boxShadow: [
                  BoxShadow(
                    color: const Color(0xFFC61111).withValues(alpha: 0.3),
                    blurRadius: 20,
              ...
              child: const Center(
                child: Column(
                  children: [
                    Icon(Icons.hotel_rounded, size: 48, color: Colors.white),
                    SizedBox(height: 12),
                    Text(
                      'Hoş Geldiniz',
                      style: TextStyle(
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        'Size en uygun giriş yöntemini seçerek işlemlerinize devam edebilirsiniz.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 16,
                      ...
                      _SelectionButton(
                        ...
                        subtitle: 'Rezervasyon ve oda hizmetleri',
                      ...
                      _SelectionButton(
                        ...
                        subtitle: 'Resepsiyon ve sistem paneli',
...
class _SelectionButtonState extends State<_SelectionButton> with SingleTickerProviderStateMixin {
        ...
        child: ScaleTransition(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _isHovered ? const Color(0xFFC61111).withValues(alpha: 0.3) : const Color(0xFFEBEBEB), 
                width: 1.5
              ),
              boxShadow: [
                BoxShadow(
                  color: _isHovered 
                      ? const Color(0xFFC61111).withValues(alpha: 0.1) 
