...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Widget _buildReceptionTrafficTable(List<HotelReservation> traffic) {
    final todayTraffic = List<HotelReservation>.from(traffic);
                    ...
                    child: DataTable(
                      ...
                      rows: todayTraffic.map((res) {
                        return DataRow(cells: [
                          ...
                          DataCell(Text(
                            res.isCheckedOut ? 'OUT' : (res.isCheckedIn ? 'IN' : 'BEKLİYOR'), 
                            style: TextStyle(
                              color: res.isCheckedOut ? Colors.orange : (res.isCheckedIn ? Colors.greenAccent : Colors.amberAccent), 
